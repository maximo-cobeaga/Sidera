...
independiente con skirts y servicio de generación cancelable fuera del game thread. Diez
pruebas nuevas; **85/85 Automation**. `TL_11` consume el constructor del patch raíz; su runtime
...
El selector quadtree/LOD balanceado ya está implementado como función pura y cubre las seis
caras con delta de vecinos ≤ 1, presupuesto acotado y determinismo. Sigue pendiente el backend
...
el puente de P2.3, paga la reconstrucción excesiva heredada y abre `TL_13_CollisionRing`.
